# This Repo contains an example of deploying a Google ADK agent on Cloud Run instance. This is for local testing
...
#### Step 6 -  Deploy using adk deploy cloud_run
#### 
"""
...
#### https://capital-agent-service-620436740598.us-central1.run.app/
